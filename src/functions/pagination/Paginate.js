...
function Paginate(
    ...
    if (!this.pages) {
        throw new TypeError("Specify pages to be shown");
    }
    if (!this.options.time) {
        throw new TypeError("Specify a reaction time.");
    }
    ...
    this.editEmoji = function (name, value) {
        if (!name) {
            throw new TypeError("Specify the emoji name to be edited");
        }
        if (!value) {
            throw new TypeError("Specify an emoji.");
        }
        switch (name) {
            case "backward":
