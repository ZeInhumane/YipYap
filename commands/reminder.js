module.exports = {
    ...
    execute(message, args) {
        ...
        if (message.member.roles.cache.some(role => role.name === 'cat') || message.member.permissions.has(['KICK_MEMBERS']) || message.member.hasPermission(['BAN_MEMBERS'])) {
